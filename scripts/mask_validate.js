...
function preformat(e, text) {
  ...
  function switchValidations(e) {
    switch (e.dataset.validate) {
      case "text":
        searcher(e, /^[a-zA-ZÃƒáº¼Ä¨Ã•Å¨Ã£áº½Ä©ÃµÅ©ÃÃ‰ÃÃ“ÃšÃ¡Ã©Ã­Ã³ÃºÃ‚ÃŠÃŽÃ”Ã›Ã¢ÃªÃ®Ã´Ã»Ã€ÃˆÃŒÃ’Ã™Ã Ã¨Ã¬Ã²Ã¹Ã„Ã‹ÃÃ–ÃœÃ¤Ã«Ã¯Ã¶Ã¼' ]*$/);
        break;
      case "num":
        searcher(e, /^[\d]*$/g);
        break;
      case "cpf":
        validateCpf(e.value) || "" == e.value ? validsIt(e) : invalidsIt(e, "Este CPF Ã© invÃ¡lido.");
        break;
      case "cnpj":
        validateCnpj(e.value) || "" == e.value ? validsIt(e) : invalidsIt(e, "Este CNPJ Ã© invÃ¡lido.");
        break;
      case "brPhone":
        validateBrPhone(e.value) || "" == e.value ? validsIt(e) : invalidsIt(e, "Este Telefone Ã© invÃ¡lido.");
        break;
      case "date":
        validateDate(e.value) || "" == e.value ? validsIt(e) : invalidsIt(e, "Esta data Ã© invÃ¡lida.");
        break;
      case "cep":
        break;
      default:
  ...
  function viacep(input, callback) {
      ...
      if (cep != "") {
        if (cep.length != 8) {
          invalidsIt(input, "Este CEP Ã© invÃ¡lido.");
          console.log("OI")
          callback({erro: true});
        }
  ...
  /*Code below test*/
  // Esta opÃ§Ã£o funcionou melhor que as demais 
  //personaliza msg da validaÃ§Ã£o input vazio html5 
  // para usar basta inseir oninput="this.setCustomValidity('')" e isto oninvalid="this.setCustomValidity('')"
  // nas propriedades do input dentro do HTML
  ...
  //                e.target.setCustomValidity("Campo de preenchimento obrigatÃ³rio");
  //            }
  //        };
  ...
  //personaliza msg da validaÃ§Ã£o input vazio html5
  // para usar basta inseir isto oninvalid="InvalidMsgCart(this);" e isto oninput="InvalidMsgCart(this);"
  // nas propriedades do input dentro do HTML
  //const msg = document.form.carteirinha.setCustomValidity("ObrigatÃ³rio informar nÃºmero de carteirinha")
  ...
  // para usar basta inseir isto oninvalid="InvalidMsgCart(this);" e isto oninput="InvalidMsgCart(this);"
  // nas propriedades do input dentro do HTML
  //function InvalidMsgCart(textbox) {
  //    if (textbox.value === '') {
  //        textbox.setCustomValidity('ObrigatÃ³rio informar nÃºmero de carteirinha');
  //    } else {
  //       textbox.setCustomValidity('');
  //    }
  //    return true;
  //}
  //function InvalidMsgDt(textbox) {
  //    if (textbox.value === '') {
  //        textbox.setCustomValidity('ObrigatÃ³rio informar data de nascimento');
  //    } else {
  //       textbox.setCustomValidity('');
  //    }
  //    return true;
  //}
  //function InvalidMsgCPF(textbox) {
  //    if (textbox.value === '') {
  //        textbox.setCustomValidity('ObrigatÃ³rio informar CPF');
  //    } else {
  //       textbox.setCustomValidity('');
  //    }
  //    return true;
